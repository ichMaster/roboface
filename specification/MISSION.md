...
- **Streaming everywhere.** Every stage of a turn streams: ASR interims, LLM deltas buffered to clause boundaries, TTS audio played as it arrives. Perceived latency is a feature of the architecture, not a tuning pass.
